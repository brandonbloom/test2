...
Test2 is a modular testing lib for Clojure. Intended as the successor of clojure.test, test2 was designed by the same people behind leiningen, clojurescript, core.match, core.logic, and clojure.test itself.
